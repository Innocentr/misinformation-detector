...
function HistoryPage() {
  ...
  return (
    <div className="page-stack">
      <PageIntro
        eyebrow="History"
        title="Search and audit saved predictions."
        description="Review your earlier decisions, filter by outcome, and pull the highest-confidence samples to the top."
      />
